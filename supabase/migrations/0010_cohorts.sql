-- Foreman: Cohort program schema (ported from the `cohort` branch, renumbered
-- 0006 → 0010 to follow growth-inspection/journal migrations). The is_admin
-- alter below is a no-op if 0007_profile_is_admin already ran (IF NOT EXISTS).
