...
async function login(formData: FormData) {
  ...
  if (error) {
    ...
    // Email-not-confirmed is the one error that needs a specific
    // response — without it the user gets a misleading "wrong password"
    // when the real issue is that they need to click the email link.
    // (Generic "invalid credentials" otherwise — no account enumeration.)
