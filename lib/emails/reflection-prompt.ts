          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:520px;background:#FAF7F2;border:1px solid rgba(26,24,22,0.10);border-radius:12px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:8px 28px 4px;">
                <p style="margin:0;font-family:'IBM Plex Mono',ui-monospace,monospace;font-size:11px;letter-spacing:0.06em;text-transform:uppercase;color:#8E6529;">SABBATH · REFLECTION</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:12px 28px 8px;">
                <a href="${escapeHtml(appUrl)}/app/checkin" style="display:inline-block;background:#1A1816;color:#FAF7F2;font-size:15px;font-weight:500;padding:12px 20px;border-radius:8px;text-decoration:none;font-family:-apple-system,BlinkMacSystemFont,sans-serif;">Open your reflection</a>
              </td>
            </tr>
            <tr>
