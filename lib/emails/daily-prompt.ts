          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:520px;background:#FAF7F2;border:1px solid rgba(26,24,22,0.10);border-radius:12px;overflow:hidden;">
            <tr>
              <td style="padding:24px 28px 12px;">
                <div style="display:inline-flex;align-items:center;gap:8px;">
                  ...
                  <span style="font-family:'IBM Plex Mono',ui-monospace,monospace;font-size:11px;letter-spacing:0.12em;color:#1A1816;">FOREMAN</span>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:8px 28px 4px;">
                <p style="margin:0;font-family:'IBM Plex Mono',ui-monospace,monospace;font-size:11px;letter-spacing:0.06em;text-transform:uppercase;color:#8E6529;">TODAY · CHECK-IN</p>
              </td>
            </tr>
            <tr>
              <td style="padding:8px 28px 0;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td style="width:2px;background:#B8843F;border-radius:1px;padding:0;">&nbsp;</td>
                    <td style="padding:0 0 0 16px;">
                      <p style="margin:0;font-family:Georgia,'Times New Roman',serif;font-style:italic;font-size:22px;line-height:1.35;color:#1A1816;">${escapeHtml(
                        promptText,
                      )}</p>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding:28px 28px 8px;">
                <a href="${escapeHtml(appUrl)}/app/checkin" style="display:inline-block;background:#1A1816;color:#FAF7F2;font-size:15px;font-weight:500;padding:12px 20px;border-radius:8px;text-decoration:none;font-family:-apple-system,BlinkMacSystemFont,sans-serif;">Open the check-in</a>
              </td>
            </tr>
            <tr>
              <td style="padding:8px 28px 24px;">
                <p style="margin:0;font-family:'IBM Plex Mono',ui-monospace,monospace;font-size:11px;color:#6B6358;">Five minutes. One question. Then coaching back.</p>
              </td>
            </tr>
            <tr>
              <td style="border-top:1px solid rgba(26,24,22,0.10);padding:18px 28px;">
